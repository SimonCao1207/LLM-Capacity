...
wandb_run_name = "gpt2-7M"  # 'run' + str(time.time())
out_dir = "out/synthetic_7M_1M"  # output directory
...
max_iters = 10000  # increase this to 1e6 to match original paper setting
weight_decay = 1e-1
beta1 = 0.9
beta2 = 0.95
...
# NOTE: compile currently not work on server 1
...
while True:
    ...
    # evaluate the loss on train sets and write checkpoints
    ...
    if iter_num > max_iters:
        torch.save(checkpoint, os.path.join(out_dir, f"ckpt_{max_iters}.pt"))
        break
